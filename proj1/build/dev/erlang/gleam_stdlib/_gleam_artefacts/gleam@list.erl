...
-spec partition_loop(list(BGB), fun((BGB) -> boolean()), list(BGB), list(BGB)) -> {list(BGB),
    list(BGB)}.
...
) -> {gleam@dict:dict(integer(), ASV), list(ASV)}.
...
-spec build_reservoir(list(ASQ), integer()) -> {gleam@dict:dict(integer(), ASQ),
    list(ASQ)}.
