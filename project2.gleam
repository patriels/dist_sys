...
pub fn main() -> Nil {
  ...
  case len {
    ...
    _ -> {
      io.println("Not enough arguments, " <> int.to_string(len))
    }
  }
}
...
fn worker_handle_message(
  ...
  case message {
    ...
    Start -> {
      io.println("recieved start message")
...
pub fn start_workers(
  ...
  case n > 0 {
    ...
    False -> {
      io.println("created workers: " <> int.to_string(list.length(workers)))
