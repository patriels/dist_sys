...
-export([is_empty/1, length/1, reverse/1, replace/3, lowercase/1, uppercase/1, compare/2, slice/3, crop/2, drop_start/2, drop_end/2, contains/2, starts_with/2, ends_with/2, split_once/2, append/2, concat/1, repeat/2, join/2, pad_start/3, pad_end/3, trim_start/1, trim_end/1, trim/1, pop_grapheme/1, to_graphemes/1, split/2, to_utf_codepoints/1, from_utf_codepoints/1, utf_codepoint/1, utf_codepoint_to_int/1, to_option/1, first/1, last/1, capitalise/1, inspect/1, byte_size/1]).
...
drop_start(String, Num_graphemes) ->
    case Num_graphemes =< 0 of
        ...
        false ->
            slice(String, Num_graphemes, string:length(String))
    end.

-file("src\\gleam\\string.gleam", 250).
?DOC(
...
-file("src\\gleam\\string.gleam", 291).
?DOC(
...
-file("src\\gleam\\string.gleam", 304).
?DOC(
...
-file("src\\gleam\\string.gleam", 343).
?DOC(
...
-file("src\\gleam\\string.gleam", 374).
?DOC(
...
-file("src\\gleam\\string.gleam", 394).
...
-file("src\\gleam\\string.gleam", 390).
?DOC(
...
-file("src\\gleam\\string.gleam", 419).
...
-file("src\\gleam\\string.gleam", 449).
...
-file("src\\gleam\\string.gleam", 480).
?DOC(
...
-file("src\\gleam\\string.gleam", 513).
?DOC(
...
-file("src\\gleam\\string.gleam", 571).
?DOC(
...
-file("src\\gleam\\string.gleam", 585).
?DOC(
...
-file("src\\gleam\\string.gleam", 612).
?DOC(
...
-file("src\\gleam\\string.gleam", 628).
...
-file("src\\gleam\\string.gleam", 623).
?DOC(
...
-file("src\\gleam\\string.gleam", 315).
?DOC(
...
-file("src\\gleam\\string.gleam", 675).
...
-file("src\\gleam\\string.gleam", 715).
?DOC(
...
-file("src\\gleam\\string.gleam", 742).
?DOC(
...
-file("src\\gleam\\string.gleam", 759).
?DOC(
...
-file("src\\gleam\\string.gleam", 782).
?DOC(
...
-file("src\\gleam\\string.gleam", 805).
?DOC(
...
-file("src\\gleam\\string.gleam", 823).
?DOC(
...
-file("src\\gleam\\string.gleam", 854).
?DOC(
...
-file("src\\gleam\\string.gleam", 877).
?DOC(
